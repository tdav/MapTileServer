                    ...
                    while (reader.Read())
                    {
                        ...
                        switch (name.ToLower())
                        {
                            case "bounds":
                                ...
                                {
                                    West = Convert.ToDouble(vals[0], CultureInfo.InvariantCulture),
                                    South = Convert.ToDouble(vals[1], CultureInfo.InvariantCulture),
                                    East = Convert.ToDouble(vals[2], CultureInfo.InvariantCulture),
                                    North = Convert.ToDouble(vals[3], CultureInfo.InvariantCulture)
                                };
                                break;
                            ...
                            case "center":
                                ...
                                {
                                    X = Convert.ToDouble(vals[0], CultureInfo.InvariantCulture),
                                    Y = Convert.ToDouble(vals[1], CultureInfo.InvariantCulture)
                                };
                                break;

                            case "minzoom":
                                this.MinZoom = Convert.ToInt32(reader["value"], CultureInfo.InvariantCulture);
                                break;

                            case "maxzoom":
                                this.MaxZoom = Convert.ToInt32(reader["value"], CultureInfo.InvariantCulture);
                                break;
